...
def add_to_calculation(elem):
    global calculation
    calculation += str(elem)
    text_result.delete(1.0, "end")
...
btn_paren_open = tk.Button(root, text="(", command=lambda: add_to_calculation('('), width=5, font=('Arial', 14))
btn_paren_open.grid(row=5, column=1)

btn_paren_close = tk.Button(root, text=")", command=lambda: add_to_calculation(')'), width=5, font=('Arial', 14))
